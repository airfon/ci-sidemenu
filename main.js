(function()  {
	...
	<style>
      ...
      <div class="navigation-menu">
         <div class="menu-item-container" id="MenuItem1">
         ...
         <div class="menu-item-container" id="MenuItem2">
            <svg class="menu-item-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 32 32" preserveAspectRatio="xMidYMid" x="0px" y="0px">
         ...
         <div class="menu-item-container" id="MenuItem3">
            <svg class="menu-item-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 32 32" preserveAspectRatio="xMidYMid" x="0px" y="0px">
         ...
         <div class="menu-item-container" id="MenuItem4">
            <svg class="menu-item-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 32 32" preserveAspectRatio="xMidYMid" x="0px" y="0px">
