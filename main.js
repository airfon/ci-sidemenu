(function()  {
	customElements.define('com-str-costinsights-sidebar', class SideBar extends HTMLElement {
		constructor() {
			...
			.menu-item-icon {position: absolute;top: 17px;left: 22px;cursor: default;}
